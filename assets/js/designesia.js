 /* --------------------------------------------------
  * © Copyright 2023 - Wellfolio by Designesia
  * --------------------------------------------------*/
(function($) {
	'use strict';
     ...
     function menu_arrow() {
         ...
         jQuery(".pf-klik").on("click", function() {
             var iteration = $(this).data('iteration') || 1;
             switch (iteration) {
                 case 1:
                    $(this).parent().find('.pf-reveal').addClass("open");
                    $(this).addClass('klik');
                     break;
                 case 2:
                    $(this).parent().find('.pf-reveal').removeClass("open");
     ...
     function init_de() {
        ...
        jQuery("#selector .opt").on("click", function() {
            ...
            }else if(color=="scheme-02"){
                $('#logo-image').attr("src", "images/logo-orange.png");
            }else if(color=="scheme-03"){
                $('#logo-image').attr("src", "images/logo-green.png");
            }else if(color=="scheme-04"){
                $('#logo-image').attr("src", "images/logo-teal.png");
            }else if(color=="scheme-05"){
                $('#logo-image').attr("src", "images/logo-blue.png");
            }else if(color=="scheme-06"){
                $('#logo-image').attr("src", "images/logo-purple.png");
            }else if(color=="scheme-07"){
                $('#logo-image').attr("src", "images/logo-pink.png");
            }
         });
